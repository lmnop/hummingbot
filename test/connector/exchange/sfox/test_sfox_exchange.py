...
from hummingbot.connector.exchange.sfox.sfox_exchange import SfoxExchange
...
class SfoxExchangeUnitTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.connector: SfoxExchange = SfoxExchange(
            sfox_api_key=API_KEY,
            trading_pairs=[cls.trading_pair],
            trading_required=True
        )
        print("Initializing SFOX market... this will take about a minute.")
    ...
    def test_orders_saving_and_restoration(self):
        ...
        try:
            ...
            self.event_logger.clear()
            new_connector = SfoxExchange(API_KEY, [self.trading_pair], True)
            for event_tag in self.events:
