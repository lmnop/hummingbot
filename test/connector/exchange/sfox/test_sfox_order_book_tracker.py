...
class SfoxOrderBookTrackerUnitTest(unittest.TestCase):
    order_book_tracker: Optional[SfoxOrderBookTracker] = None
    ...
    def setUpClass(cls):
        ...
        cls.order_book_tracker: SfoxOrderBookTracker = SfoxOrderBookTracker(trading_pairs=cls.trading_pairs)
    ...
    def test_tracker_integrity(self):
        ...
        self.assertIsNot(eth_usd.snapshot_uid, 0)
    ...
    def test_api_get_last_traded_prices(self):
        prices = self.ev_loop.run_until_complete(
            SfoxAPIOrderBookDataSource.get_last_traded_prices(["BTC-USD", "LTC-BTC"]))
